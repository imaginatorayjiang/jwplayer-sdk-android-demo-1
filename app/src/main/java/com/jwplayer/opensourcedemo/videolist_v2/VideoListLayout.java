    ...
    private void initActions() {
        ...
        adapter.setClick(new VideoAdapter.onClick() {
            ...
            public void onclick(int position) {
                ...
                if (videoItemView.VideoStatus() == videoItemView.getPlayer().getState().PAUSED) {
                ...
                {
                    ViewGroup last = (ViewGroup) videoItemView
                        .getParent();//找到videoitemview的父类，然后remove
                    if (last != null) {
                        last.removeAllViews();
        ...
        videoList.addOnChildAttachStateChangeListener(
                ...
                public void onChildViewAttachedToWindow(View view) {
                    ...
                    if (index == postion) {
                        ...
                        if (videoItemView != null &&
                            ((videoItemView.isPlay()) || videoItemView
                                .VideoStatus() == videoItemView.getPlayer().getState().PAUSED)) {
                            view.findViewById(R.id.showview).setVisibility(View.GONE);
                        }

                        if (videoItemView.VideoStatus() == videoItemView.getPlayer()
                            .getState().PAUSED) {
                            if (videoItemView.getParent() != null)
                                ((ViewGroup) videoItemView.getParent()).removeAllViews();
                            frameLayout.addView(videoItemView);
                        ...
                        if (smallLayout
                            .getVisibility() == View.VISIBLE && videoItemView != null &&
                            videoItemView
                                .isPlay()) {
                            smallLayout.setVisibility(View.GONE);
                            videoLayout.removeAllViews();
